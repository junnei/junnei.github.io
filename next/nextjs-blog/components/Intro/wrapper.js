    ...
    return (
        <>
            ...
            <div className="px-5vw mb-10vh py-10vh mx-10vw md:mx-0 h-30vh md:w-50vh bg-gradient-to-br from-yellow-400 via-green-500 to-indigo-500"> 
                <h1 className="intro-hero-hover z-10 absolute text-gray-100 md:bg-gradient-to-r md:from-red-500 text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-tight md:pr-2">
                    SEONG JUN
                </h1>
